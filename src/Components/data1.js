...
export const blogdeta = [
    {
        ...
        desc3: "ㅤㅤㅤI embarked on Python and quickly ventured into machine learning, creating my virtual partner, Newton.AI. This AI helped with tasks like weather forecasting, chatbot interactions, research assistance, and more. Creating it was a significant achievement. I then delved into Discord and Mojang bot development, crafting bots for a StudyServer named StudyHut. The technology landscape was ever-evolving, but I decided to revisit React and built the official desktop study app, Radium, realizing there's much more to explore and share in this journey.",
        conc: "So Learning Programming is blunder mostly do, We should only focus on practice and logic instead of mugging up everything, Mechanism is very much necessary for progress. here is Roadmap I will follow to become Fullstack programmer.",
        cover: a1,
        image: b1,
        thumb:c1,
        date: "24-09-2023 ",
    },
    {
        ...
        desc3: "ㅤㅤㅤWhen you master time management, you experience a sense of accomplishment and control over your life. You'll find that you have more time for the things that truly matter to you, whether it's pursuing your passions, nurturing relationships, or simply taking a moment to relax. This newfound balance and productivity can lead to increased satisfaction and overall well-being, making you appreciate the art of time management even more.",
        conc: "Effective time management empowers individuals to prioritize tasks, maintain focus, and find satisfaction in their daily pursuits. It is the key to achieving productivity, balance, and personal fulfillment in both personal and professional endeavors.",
        cover: a2,
        image: b2,
        thumb:c2,
        date: "01-10-2023 ",
    },
    {
        ...
        desc3: "ㅤㅤㅤShort tasks are instrumental in structured execution and goal achievement. They allow you to create a well-defined roadmap to your objectives. By setting clear targets and breaking them down into manageable tasks, you can prioritize your work effectively. Short tasks force you to focus on what truly matters, ensuring that your efforts align with your overarching goals. This structured approach to task management not only increases your efficiency but also provides a sense of direction, making it easier to measure progress and make adjustments as needed.",
        conc: "Short tasks are a potent tool for enhancing focus, building confidence, and achieving your goals. Incorporating them into your daily routine can lead to increased productivity and a greater sense of accomplishment.",
        cover: a3,
        image: b3,        
        thumb:c3,
        date: "03-10-2023 ",
    },
    {
        ...
        desc3: "ㅤㅤㅤTo maximize knowledge retention, it's crucial to analyze the study and revision methods used. Research has shown that spaced repetition, self-testing, and summarization can enhance retention significantly. Additionally, being honest with oneself about comprehension and seeking clarification when needed can lead to more effective learning experiences. Understanding the retention curve and its underlying factors can empower individuals to tailor their learning strategies for better long-term memory retention.",
        conc: "The retention curve is a fundamental concept in learning and memory. To optimize knowledge retention, individuals should employ effective study methods, revise regularly, and honestly assess their understanding.",
        cover: a4,
        image: b4,
        thumb:c4,
        date: "06-10-2023 ",
